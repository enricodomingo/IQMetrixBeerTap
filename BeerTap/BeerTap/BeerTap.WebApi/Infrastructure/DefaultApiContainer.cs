...
namespace BeerTap.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        readonly Assembly _resourceMappersAssembly = typeof(IOfficeApiService).Assembly;
        readonly Assembly _beerTapAssemby = typeof(IBeerTapService).Assembly;
        ...
        protected override Assembly ResourceSpecsAssembly { get { return typeof(Hypermedia.OfficeSpec).Assembly; } }
        protected override Assembly ResourceStateProvidersAssembly { get { return typeof(Hypermedia.OfficeSpec).Assembly; } }
        protected override Assembly ApiAppServicesAssembly { get { return typeof(IOfficeApiService).Assembly; } }
                ...
                .Install(new IWindsorInstaller[]
                         {
                             ...
                             new ResourceMapperInstaller(_resourceMappersAssembly),new BeerTapMapperInstaller(_beerTapAssemby),
